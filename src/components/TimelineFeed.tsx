...
export default function TimelineFeed({ denuncias, onFlyTo, onClose }: TimelineFeedProps) {
  ...
  // Auto-scroll para o topo quando chega denuncia nova
  useEffect(() => {
    if (listRef.current) {
